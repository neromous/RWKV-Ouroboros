...
class RWKV(nn.Module):
    ...
    def local_forward(self, idx: torch.Tensor, last_shift_states: torch.Tensor,
    ...
    def compute_loss(self, batch, batch_idx, do_cutoff: bool):
        ...
        def checkpointed_step(idx, targets, mask, prev_loss, last_shift_states,
            ...
            logits, new_shift_states, new_wkv_states = self.local_forward(
