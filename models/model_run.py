...
# def matmul(a, b, output_dtype: Optional[torch.dtype]=None) -> torch.Tensor:
...
class RWKV_RNN(MyModule):
    def __init__(self, model_weight,dtype='bf16'):
        super().__init__()
